...
class PDF(FPDF):
    def header(self):
        ...
        doc_w = self.w
        self.image('pdf\logo.png',(doc_w-25)/2,10,25)
        title_fr='BANQUE NATIONALE AGRICOLE\nSociété Anonyme au capital de 176.000.000 DT'
          # Thickness of frame (border)
        self.set_line_width(1)
        # Title
        self.image('pdf\Capture.PNG',120,10,80)
        self.multi_cell(0, 10, title_fr,align= 'L')
        today = date.today()
        tdate = today.strftime("%d-%m-%Y")
        str='Tunis le : '+tdate
        self.cell(0, 10, str, align='R')
    ...
    def extrait_title(self):
        ...
        self.set_line_width(1)
        title = f'EXTRAIT DU COMPTE'
        self.ln()
        self.ln()
        self.cell(0, 5, title,align='C')
        # line break
    ...
    def account_data(self):
        ...
        self.set_line_width(1)
        self.ln()
        self.multi_cell(0, 10, t1, align= 'L')
        t2 = 'Etat du compte : Valide'
        t2 += '\nDevise : DINARS TUNISIEN' 
        self.ln(0)
        self.multi_cell(0, 10, t2, align='j')
    ...
    def create_table(self, table_data, title='', data_size = 10, title_size=12, align_data='L', align_header='L', cell_width='even', x_start='x_default',emphasize_data=[], emphasize_style=None,emphasize_color=(0,0,0)):
        ...
        def get_col_widths():
            ...
            if col_width == 'even':
                col_width = 46.50038888888888  # distribute content evenly   # epw = effective page width (width of page not including margins)
                print(col_width)
